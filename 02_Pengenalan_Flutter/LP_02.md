...
### 2. Widget
Widget merupakan seluruh tampilan pada aplikasi anda seperti tombol, gambar, text, list, ikon, dan layout. pada flutter arsitektur yang digunakan adalah widget, jadi hampir semua yang ditampilkan di layar merupakan sebuah widget atau kombinasi dari widget lain.

### Macam-Macam Widget Didalam flutter : 
