...
7. Padding: Digunakan untuk memberi ruang (padding) di sekitar child widget.
8. Text: Digunakan untuk menampilkan teks.
9. Row: Widget layout yang menyusun child-nya dalam arah horizontal (sejajar dari kiri ke kanan).
10. Column: Widget layout yang menyusun child-nya dalam arah vertikal (sejajar dari atas ke bawah).
